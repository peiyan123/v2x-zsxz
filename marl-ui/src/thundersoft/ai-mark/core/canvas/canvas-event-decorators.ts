  ...
  return class extends constructor {
    ...
    bindingElementEvents(element: Element) {
      ...
      this.canvasElementEvents = {
        ...
        // 移动端事件
        touchmove: fromEvent(element, 'touchmove'),
        touchstart: fromEvent(element, 'touchstart'),
        touchend: fromEvent(element, 'touchend'),
        touchenter: fromEvent(element, 'touchenter'),
        touchleave: fromEvent(element, 'touchleave')
      }
    }
    // 获取左键 单击/双击 ，绝对事件
