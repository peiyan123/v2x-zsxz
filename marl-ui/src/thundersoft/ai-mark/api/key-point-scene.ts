...
import { MarkPointDecorators } from '../core/mark'
...
export class KeyPointScene {
    ...
    constructor(el: HTMLElement, url?: string, markData: ShapePointData[] = []) {
        ...
        // 对象选中事件
        this.destroyEvent.push(this.markCanvas.shapeSelectedBeforeEvent?.subscribe(shape => {
    ...
    deleteSelected() {
        ...
        // 删除对象
            ...
            this.markCanvas.markMap?.delete(shape.shapeId!)
