...
export default defineComponent({
  ...
  setup(props) {
    ...
    const iconTemp = props.icon as string
    const isSvgIcon = computed(() => iconTemp?.endsWith(SVG_END_WITH_FLAG))
    const getSvgIcon = computed(() => iconTemp.replace(SVG_END_WITH_FLAG, ''))
