import type { TreeDataItem, AntTreeNodeCheckedEvent } from 'ant-design-vue/es/tree/Tree'
import { ContextMenuItem } from '@/core/hooks/useContextMenu'
...
export type CheckEvent = AntTreeNodeCheckedEvent
